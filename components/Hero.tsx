  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-3xl">
        <p className="font-[var(--font-display)] text-sm uppercase tracking-[0.2em] text-[#F52500]">
          {site.name}
        </p>
        <h1
          id="hero-heading"
          className="mt-2 font-[var(--font-display)] text-5xl leading-none tracking-[0.04em] text-white md:text-7xl"
        >
          Strength through discipline
        </h1>
        <p className="mx-auto mt-4 max-w-[40ch] text-lg text-neutral-400">{site.mission}</p>
        <p className="mx-auto mt-3 max-w-[36ch] text-sm text-neutral-500">
